...
description: >-
  ...
  Codex drafts from repo context, the user confirms or edits each field.
...
The division of labour is fixed: **Codex drafts, the user decides.** Nothing
is marked agreed until the user has confirmed it.

## Files

- Schema template: `.Codex/skills/spec/template.md`
...
- **Draft before asking.** Read the relevant context first — `AGENTS.md`
...
- **Constraints & invariants**: always state which of `AGENTS.md`'s
